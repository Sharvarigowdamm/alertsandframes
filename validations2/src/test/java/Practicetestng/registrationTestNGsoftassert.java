...
public class registrationTestNGsoftassert {
	WebDriver driver ;
@BeforeClass
		 ...
		 * js.executeScript("window.scrollBy(0,350)", "");*/
		   ...
		   driver.findElement(By.xpath("/html/body/span/span/span[1]/input")).sendKeys("aus");
			...
			SoftAssert so=new SoftAssert();
			  ...
			  try { 
				  WebElement Ele=
			  driver.findElement(By.xpath("select2-country-container")); Ele.click();
			  }
			  catch(org.openqa.selenium.NoSuchElementException e) 
			  {
			  System.out.println("Xpath not found"); so.fail("Xpath not found.");
			  }
			/*
			 * WebElement Ele= driver.findElement(By.xpath("select2-country-container")); //
			 * so.assertNotNull(Ele); so.assertNull(Ele);
			 */
...
/*
 * @Test (priority=1) public void enterdetails() {
 * 
 * }
 */
@AfterClass
