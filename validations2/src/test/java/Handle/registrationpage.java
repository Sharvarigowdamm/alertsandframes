...
public class registrationpage {
	...
	public static void main(String[] args) {
		...
		js1.executeScript("window.scrollBy(0,350)", "");
		 WebElement optionslist=driver.findElement(By.id("Skills"));
		Select dd=new Select(optionslist);
		dd.selectByIndex(1);
		...
		WebElement autoselect=driver.findElement(By.xpath("/html/body/span/span/span[1]/input"));
		autoselect.sendKeys("aus");
		autoselect.sendKeys(Keys.ENTER);
		
		/*
		 * WebDriverWait wait=new WebDriverWait(driver,Duration.ofSeconds(30));
		 * WebElement
		 * options=wait.until(ExpectedConditions.visibilityOfElementLocated(By.id(
		 * "select2-country-container"))); options.click();
		 */
